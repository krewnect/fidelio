...
logo_ui = """
                            <div class="apple-input-group">
                                ...
                                <div style="display:flex; align-items:center; gap:16px;">
                                    <div style="flex:1; border: 2px dashed #cbd5e1; background:#f8fafc; border-radius:12px; padding:16px; text-align:center; cursor:pointer; transition:all 0.2s;" onmouseover="this.style.borderColor='#8b5cf6'" onmouseout="this.style.borderColor='#cbd5e1'" onclick="document.getElementById('logo-file-input').click()">
...
target = r'<div class="apple-input-group">\s*<label class="apple-label">Nombre del Negocio / Especialista</label>'
html = re.sub(target, logo_ui + '\n                            <div class="apple-input-group">\n                                <label class="apple-label">Nombre del Negocio / Especialista</label>', html)
